...
public class StoneTile extends Tile {
	...
	public StoneTile(float x, float y) {
		super(5, x, y, new BasicModel(TextureManager.TILE_STONE, "body"), true, 100);
	}

	@Override
	protected void drop() {
		EntityManager.drops.add(new Drop(pos.x + random.nextInt(EntityManager.TILE_SIZE - (int)(EntityManager.TILE_SIZE * .25f)), pos.y, new ItemStack(new Item("Stone", model), 1)));
	}
