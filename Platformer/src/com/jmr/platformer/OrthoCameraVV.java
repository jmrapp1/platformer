...
public class OrthoCameraVV extends OrthographicCamera {
	...
	public OrthoCameraVV(VirtualViewport virtualViewport) {
		this(virtualViewport, 0f, 0f);
	}

	public OrthoCameraVV(VirtualViewport virtualViewport, float cx, float cy) {
		this.virtualViewport = virtualViewport;
